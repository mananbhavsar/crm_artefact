    ...
    <div class="panel-default panel-table borderten lead-manager-head" style="overflow: scroll;">
      <div class="panel-heading">
        <div id="details" class="clearfix" style="font-size: 12px;">
          <div id="proposal">
            <h1><?php echo $proposals['proposal_number'] ?></h1>
        ...
        <div class="btn-group col-md-12 md-pr-0 md-pl-0 md-pb-10">
          <?php if($proposals['status_id'] == 1 || $proposals['status_id'] == 2 || $proposals['status_id'] == 3 || $proposals['status_id'] == 4 ) { ?>
        ...
        <?php }?>
        <div style="<?php if($proposals['comment']!=1){echo 'display:none;';}?>"> <?php echo form_open_multipart('share/customercomment',array("class"=>"")); ?>
