            ...
            <div class="proposal">
              <main>
                ...
                <div class="col-md-12 md-pr-0" style="font-weight: 900; font-size: 16px; color: #c7c7c7;">
					<div class="col-md-6">
					  <?php if($userInfo['role_name'] !='Sales Team'){ ?>
						<div class="col-md-5">
							<div class="text-right text-uppercase text-muted"><?php echo $orders['cost_amount'] > 0 ?  lang('total_cost').':' :'' ;?></div>
							<div class="text-right text-uppercase text-muted"><?php echo $orders['profit_amt'] > 0 ? lang('estimated_profit').':' :'';?></div>
						</div>
						<div class="col-md-7">
							<div class="text-left"><?php echo $orders['cost_amount'] > 0 ? $orders['cost_amount'] : ''; ?></div>
							<div class="text-left"><?php echo $orders['profit_amt'] > 0 ? number_format(($orders['profit_amt'] + $orders['quote_profit_amt']), 2) : '0.00'; ?></div>
						</div>
					  <?php } ?>
					</div>
				  <div class="col-md-6">
...
<script>
  ...
  lang.convert_text = "<?php echo lang('convertmsg').' '.lang('order').' '.lang('to').' '.lang('project')?>";
  lang.convert = "<?php echo lang('convert')?>";
</script>
