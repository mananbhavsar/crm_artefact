...
<head>
	...
	<title><?php echo $proposals['proposal_number']?>&nbsp;<?php echo $proposals['subject'] ?></title>
			...
			<div class="proposal panel borderten" style="padding-top: 20px;padding-right: 0px;">
				<main>
					<div id="details" class="clearfix">
						<div id="client">
							<h1><b><?php echo $proposals['proposal_number']?>&nbsp;<?php echo $proposals['subject'] ?></b></h1>
