	...
	<div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
		<md-toolbar class="toolbar-white">
			<div class="md-toolbar-tools">
				<div class="col-sm-11">
				    <span style="font-size: 16px;">Document View</span><br>
				...
				<div class="col-sm-1">
					<?php if (check_privilege('document', 'edit')){ ?> 
						<span id="" onclick="update('<?php echo $result['document_id']; ?>')" title="Edit" class="cursor"><i class="ion-compose  text-muted"></i></span>&nbsp;
					<?php } 
		...
		<md-content ng-show="!ticketsLoader" layout-padding class="bg-white" style="overflow: hidden;" ng-cloak>
			...
			<div class="ciuis-ticket-row">
				...
				<div class="ciuis-ticket-fieldgroup">
					...
					<div class="ticket-data">
						<div class="ticket-data label-status" ng-bind="'<?php echo date("d-m-Y",strtotime($result['expiry_date'])); ?>'"></div>
					</div>
				</div>
			</div>
			<div class="ciuis-ticket-row">
...
<?php if (check_privilege('document', 'edit')) { ?> 
    ...
    <md-content class="bg-white" ng-show="!documentFiles">
		...
		<a href='#about' onclick=show_post_pdf(<?php echo $pass_value; ?>) data-toggle='modal' data-image=<?php echo $pass_value; ?> id='editidpdf<?php echo $pass_value;?>'></a>
         ...
         <md-list-item class="md-2-line" ng-repeat="file in files1 | pagination : currentPage*itemsPerPage | limitTo: 6">
          <div class="md-list-item-text image-preview">
            <a ng-if="file.type == 'image'" class="cursor" ng-click="ViewFiledoc($index, image)">
      ...
      <div ng-show="files.length>6 && !documentFiles" class="pagination-div" ng-cloak>
        <ul class="pagination">
...
switch(getExtension(img)) {
  ...
  var TASKID = "<?php echo $result['document_id'];?>";
