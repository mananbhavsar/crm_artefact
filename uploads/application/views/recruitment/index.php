...
<div class="ciuis-body-content" ng-controller="Staffs_Controller">
  <div class="main-content container-fluid col-xs-16 col-md-16 col-lg-16" layout="row" layout-wrap>
    ...
    <div class="md-toolbar-tools">
      ...
      <h2 flex md-truncate><?php echo 'Recruitment' ?> <small></small></h2>
      ...
      <md-button ng-show="showGrid==true" ng-click="showList=false;showGrid=true;" class="md-icon-button" aria-label="New" ng-cloak>
      ...
      <?php if (check_privilege('recruitment', 'create')) { ?>
        <md-button ng-click="Create()" class="md-icon-button" aria-label="New" ng-cloak>
          <md-tooltip md-direction="bottom"><?php echo lang('create').' '.'Candidates' ?></md-tooltip>
    ...
    <md-content flex-gt-xs="100" flex-xs="100"  class="bg-white" ng-cloak style="margin: -20px 10px 20px 30px;">
      <md-table-container >
		...
		<?php if($cand['file_name'] != '') { ?>
			...
			<a href="<?php  echo base_url('uploads/files/candidates/'.$cand['candidate_id'].'/'.$cand['file_name'].''); ?>"  download >Download</a>
