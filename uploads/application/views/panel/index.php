			...
			<div class="col-md-3 col-sm-3 col-lg-3 nopadding">
				...
				<md-content class="bg-white ciuis-summary-two">
					...
					<div class="hidden-xs" ng-hide="ONLYADMIN != 'true'" >
						<h4 class="text-center"><?php echo lang('sales_vs_expenses')?></h4>
						<div id="monthlyexpenses" style="height: 145px;display: block;bottom: 14px;position: absolute;width: 100%;border-bottom-left-radius: 5px;">
						</div>
					</div>
				</md-content>
			</div>
			<div class="col-sm-9 xs-p-0">
				<md-toolbar class="toolbar-white">
					<div class="md-toolbar-tools">
						...
						<md-button ng-href="<?php echo base_url('calendar') ?>" class="md-icon-button" aria-label="Event" ng-cloak>
							<md-tooltip md-direction="bottom" ng-bind='lang.calendar'></md-tooltip>
							<md-icon><i class="mdi mdi-calendar-note text-muted"></i></md-icon>
						</md-button>
						<md-button ng-click="SetOnsiteVisit();get_customers();get_staff();" class="md-icon-button" aria-label="Onsite Visits" ng-hide="ONLYADMIN != 'true'" ng-cloak>
							<md-tooltip md-direction="bottom"><?php echo lang('set_onsite_visit') ?></md-tooltip>
							<md-icon><i class="mdi mdi-slideshare text-muted"></i></md-icon>
						</md-button>
					</div>
				</md-toolbar> 
									...
									<div style="padding-top: 0px;line-height: 0.99;margin-right: 10px;" class="panel-body h-200 xs-p-0">
										...
										<div class="col-md-12 nopadding md-pt-10 xs-pt-20" style="border-top: 1px solid #e0e0e0;">
											...
											<div style="height: 10px" class="progress">
												<div style="font-size: 7px;line-height: 10px;width:{{stats.inp}}%" class="progress-bar progress-bar-success progress-bar-striped" ng-bind="stats.inp+'%'"> {{lang.incomings}}<span class="sr-only"><?php echo lang('incomings')?></span></div>
												<div style="font-size: 7px;line-height: 10px;width:{{stats.ogp}}%" class="progress-bar progress-bar-danger progress-bar-striped" ng-bind="stats.ogp+'%'"> {{lang.outgoings}}<span class="sr-only"><?php echo lang('outgoings')?></span></div>
											</div>
											<div class="row">
												<div class="col-xs-6">
											...
											<span ng-bind-html='lang.cashflowdetail|trustAsHtml'></span>
										</div>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
	var lang = {};
	lang.sales_vs_expenses = '<?php echo lang('sales_vs_expenses') ?>';
	lang.expense = '<?php echo lang('expense') ?>';
	lang.sale = '<?php echo lang('sale') ?>';
</script>
