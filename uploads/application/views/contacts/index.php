    ...
    <div class="row" style="padding: 0px 20px 0px 20px;">
      <div class="col-md-12 col-xs-6 border-right text-uppercase">
        <div class="tasks-status-stat">
          <h3 class="text-bold ciuis-task-stat-title" ng-click="open_students(0);"> <span class="task-stat-number" ng-bind="contacttype.total"></span> <span class="task-stat-all" ng-bind="'/'+' '+contacttype.total+' '+'<?php echo lang('Contacts') ?>'"></span> </h3>
          <span class="ciuis-task-percent-bg"> <span class="ciuis-task-percent-fg" style="width: {{ (contacttype.total)  /(contacttype.total)  }}%;"></span> </span> </div>
        <span style="color:#989898"><?php echo lang('All'); ?></span> </div>
      <div class="col-md-6 col-xs-6 border-right text-uppercase">
        <div class="tasks-status-stat">
          <h3 class="text-bold ciuis-task-stat-title" ng-click="open_students('business');"> <span class="task-stat-number" ng-bind="contacttype.businesstype"></span> <span class="task-stat-all" ng-bind="'/'+' '+contacttype.total+' '+'<?php echo lang('Contacts') ?>'"></span> </h3>
          <span class="ciuis-task-percent-bg"> <span class="ciuis-task-percent-fg" style="width: {{(contacttype.businesstype) * 100 / (contacttype.total) }}%;"></span> </span> </div>
        <span style="color:#989898"><?php echo lang('Companies'); ?></span> </div>
      <div class="col-md-6 col-xs-6 border-right text-uppercase">
        <div class="tasks-status-stat">
          <h3 class="text-bold ciuis-task-stat-title"  ng-click="open_students('person');"> <span class="task-stat-number" ng-bind="contacttype.persontype"></span> <span class="task-stat-all" ng-bind="'/'+' '+contacttype.total+' '+'<?php echo lang('Contacts') ?>'"></span> </h3>
          <span class="ciuis-task-percent-bg"> <span class="ciuis-task-percent-fg" style="width: {{(contacttype.persontype) * 100 / (contacttype.total) }}%;"></span> </span> </div>
...
<span id="valid-msg<?php print $p;?>" class="hide">✓ Valid</span>
<span id="error-msg<?php print $p;?>" class="hide"></span>
 <input type="hidden" id="calling_code<?php print $p;?>" name="countrycode[]"/>
    <input type="tel" id="phone<?php print $p;?>" name="point_contact_number[]">
	<script type="text/javascript">
	 setTimeout(function(){
	allshowtel('<?php print $p;?>');
	  },1000);
...
<span id="person_error-msg<?php print $p;?>" class="hide"></span>
 <input type="hidden" id="person_calling_code<?php print $p;?>" name="person_countrycode[]"/>
    <input type="tel" id="person_phone<?php print $p;?>" name="person_point_contact_number[]">
	<script type="text/javascript">
	 setTimeout(function(){
