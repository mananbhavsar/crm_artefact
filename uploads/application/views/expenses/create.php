    ...
    <md-content ng-show="!expensesLoader" class="bg-white" layout-padding ng-cloak>
      <div layout-gt-xs="row">
        ...
        <md-input-container class="md-block" flex-gt-xs ng-show="!newexpense.internal">
          <md-select required placeholder="<?php echo lang('choisecustomer'); ?>" ng-model="newexpense.customer" name="customer" style="min-width: 200px;" data-md-container-class="selectdemoSelectHeader">
