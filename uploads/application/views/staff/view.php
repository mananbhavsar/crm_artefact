           ...
           <table class="table table-bordered">
            <thead>
              ...
              <th scope="col"> Passport Expiry Date </th>
                  <th scope="col"> Passport Remind</th>
                 
                  <th scope="col">Passport DOC </th>
         ...
         <?php       $pass_doc =  str_replace(' ', ',', $value->passport_doc); ?>
          ...
          <?php }} ?>
           ...
           <table class="table table-bordered">
            <thead>
              ...
              <th scope="col"> Emirates Expiry Date </th>
                  <th scope="col"> Emirates Remind</th>
                 
                  <th scope="col">Emirates DOC </th>
          ...
          <?php }} ?>
            ...
            <thead>
              ...
              <th scope="col"> Labour Expiry Date </th>
                  <th scope="col"> Labour Remind</th>
                 
                  <th scope="col">Labour DOC </th>
          ...
          <?php }} ?>
           ...
           <table class="table table-bordered">
            <thead>
              ...
              <th scope="col"> ATM Expiry Date </th>
                  <th scope="col"> ATM Remind</th>
                 
                  <th scope="col">ATM DOC </th>
