	...
	<div class="main-content container-fluid col-xs-12 col-md-12 col-lg-3 md-pl-0">
		...
		<md-content class="bg-white">
			<md-list flex class="md-p-0 sm-p-0 lg-p-0" ng-cloak>
				<md-list-item >
					<p ng-click="open_students(0);" ><strong class="allColorDiv">All</strong> : <strong  ng-bind="payroll.total"></strong>
					</p><br>
				</md-list-item>
				<md-list-item ng-repeat="name in status" class="noright">
					<p ng-click="open_students(name.id);" ><strong style="padding-right: 15px;padding-left: 15px;width: 50%;float: left;">{{name.name}}</strong> : <strong  ng-bind="payroll.{{name.name.split(' ').join('')}}"></strong>
					</p><br>
				</md-list-item>
				<!--- <md-list-item>
