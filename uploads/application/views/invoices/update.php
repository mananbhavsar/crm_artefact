...
<div class="ciuis-body-content" ng-controller="Invoice_Controller">
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9" >
    <md-toolbar class="toolbar-white" >
      <div class="md-toolbar-tools">
        ...
        <md-switch ng-model="invoice.recurring_status" aria-label="recurring_status" ng-cloak> <strong class="text-muted"><?php echo lang('recurring') ?></strong> </md-switch>
        <md-button ng-href="<?php echo base_url('invoices/invoice/{{invoice.id}}')?>" class="md-icon-button" aria-label="View" ng-cloak>
          <md-tooltip md-direction="bottom"><?php echo lang('view') ?></md-tooltip>
          <md-icon><i class="ion-eye text-warning"></i></md-icon>
        </md-button>
        <md-button ng-href="<?php echo base_url('invoices/invoice/{{invoice.id}}')?>" class="md-icon-button" aria-label="Cancel" ng-cloak>
    ...
    <md-content ng-show="!invoiceLoader" class="bg-white" layout-padding ng-cloak>
      <div layout-gt-xs="row">
        ...
        <md-input-container class="md-block" flex-gt-xs>
          <md-select required placeholder="<?php echo lang('choisecustomer'); ?>" ng-model="invoice.customer" ng-change="changeBank(invoice.customer)" name="customer" style="min-width: 200px;" data-md-container-class="selectdemoSelectHeader">
        ...
        <md-input-container>
          ...
          <md-datepicker name="created" ng-model="invoice.created_edit" md-open-on-focus></md-datepicker>
        </md-input-container>
      </div>
      <div ng-show="invoice.recurring_status" layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker md-min-date="date" name="recurring_endDate" ng-model="invoice.recurring_endDate" md-open-on-focus></md-datepicker>
          <div >
      ...
      <div  layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker md-min-date="invoice.created_edit" name="duedate" ng-model="invoice.duedate_edit" md-open-on-focus></md-datepicker>
        </md-input-container>
  ...
  <div ng-show="!invoiceLoader" class="main-content container-fluid lg-pl-0 col-xs-12 col-md-12 col-lg-3" ng-cloak>
    <md-toolbar class="toolbar-white">
      <div class="md-toolbar-tools">
        <md-button class="md-icon-button" aria-label="Invoice" ng-disabled="true">
          <md-icon><i class="ico-ciuis-invoices text-muted"></i></md-icon>
    ...
    <md-content layout-padding class="bg-white">
      ...
      <md-content ng-if='EditBilling == true' layout-padding class="bg-white">
        ...
        <md-input-container class="md-block">
          <md-select placeholder="<?php echo lang('country'); ?>" ng-model="invoice.billing_country_id" ng-change="getBillingStates(invoice.billing_country_id)" name="billing_country_id" style="min-width: 200px;">
    ...
    <md-content  ng-show='NeedShippingAddress == true' layout-padding class="bg-white">
      ...
      <md-content ng-show='EditShipping == true' layout-padding class="bg-white">
        ...
        <md-input-container class="md-block">
          <md-select placeholder="<?php echo lang('country'); ?>" ng-model="invoice.shipping_country_id" ng-change="getShippingStates(invoice.shipping_country_id)" name="shipping_country_id"  style="min-width: 200px;">
            <md-option ng-value="{{country.id}}" ng-repeat="country in countries">{{country.shortname}}</md-option>
          </md-select><br>
        </md-input-container>
        <md-input-container class="md-block">
