    ...
    <md-content ng-show="!invoiceLoader" class="bg-white" layout-padding ng-cloak>
      <div layout-gt-xs="row">
		<md-input-container class="md-block" flex-gt-sm>
          <md-select ng-model="project" data-md-container-class="selectdemoSelectHeader">
        ...
        <md-input-container class="md-block" flex-gt-sm>
          <md-select ng-model="customer" ng-change="default_payment_method = customer.default_payment_method;
            ...
            invoice.shipping_state_id = customer.shipping_state_id;getBillingStates(customer.billing_country_id);getShippingStates(customer.shipping_country_id); ChangeCustomer(customer.id);" data-md-container-class="selectdemoSelectHeader">
          <md-select-header class="demo-select-header">
		...
		<input type="hidden" name="main_sales_team_id" id="salesteamperson" ng-model="main_sales_team_id"/>
        <md-input-container class="md-block" flex-gt-sm>
