    ...
    <div class="col-md-4 login-left hide-xs hide-sm" style="background-image: url(<?php echo base_url('assets/img/images/'.$rebrand['admin_login_image'].''); ?>) !important;">
      <div class="lg-content">
        ...
        <a href="<?php echo base_url('area'); ?>">
          <md-button class="btn btn-warning md-raised md-warn p-l-20 p-r-20 client-button"><?php echo lang('clientarea')?></md-button>
        </a>
      </div>
    </div>
          ...
          <div class="panel panel-default"> 
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <input id="email" required="" type="email" placeholder="<?php echo lang('loginemail')?>" name="email" autocomplete="off" class="form-control">
              </div>
              <div class="form-group"> 
                <input id="password" required="" type="password" name="password" placeholder="<?php echo lang('loginpassword')?>" class="form-control">
              </div>
