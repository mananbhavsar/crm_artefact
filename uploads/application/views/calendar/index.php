        ...
        <md-tabs md-dynamic-height md-border-bottom>
          ...
          <md-tab label="<?php echo lang('Holidays')?>">
            <md-content class="events events_xs calendar-events" style="margin-top: 0px">
              ...
              <ul style="padding: 0px 20px 0px 20px;" ng-cloak>
				<li ng-repeat="event in all_holidays" class="{{event.status}}">
					<div class="row">
						<div class="col-sm-12">
							<div class="col-sm-8">
							...
							<div class="col-sm-4">
								<md-icon ng-click="EditHoliday(event.id,event.title,event.event_type1,event.start,event.end,event.normal_holidays1,event.detail, $event)" class="md-secondary md-hue-3 ion-compose " aria-hidden="Edit Holiday"></md-icon>
        ...
        <div layout="row" layout-wrap ng-show="eventType==1">
          <div flex-gt-xs="50" flex-xs="50">
            <md-input-container class="md-block">
              ...
              <input mdc-datetime-picker="" date="true" time="false" type="text" id="datetime" placeholder="<?php echo lang('holiday') . ' ' . lang('start') ?>" show-todays-date="" minutes="true" min-date="date" show-icon="true" ng-model="event_start" class=" dtp-no-msclear dtp-input md-input" ng-init="event_start=date">
            </md-input-container>
          </div>
          <div flex-gt-xs="50" flex-xs="50">
            <md-input-container class="md-block">
              <label><?php echo lang('holiday') . ' ' . lang('end') ?></label>
              <input mdc-datetime-picker="" date="true" time="false" type="text" id="datetime" minutes="true" min-date="event_start" show-icon="true" ng-model="event_end" class="dtp-no-msclear dtp-input md-input" placeholder="<?php echo lang('event') . ' ' . lang('end') ?>">
            </md-input-container>
          </div>
        </div>
		<div layout="row" layout-wrap ng-show="eventType==2">
          <div flex-gt-xs="90" flex-xs="90">
            <md-input-container class="md-block">
              ...
              <md-select placeholder="<?php echo lang('days'); ?>" ng-model="normal_holidays" style="min-width: 200px;" multiple>
