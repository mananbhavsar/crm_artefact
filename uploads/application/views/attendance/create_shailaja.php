...
<div class="main-content container-fluid col-xs-12 col-md-12 col-lg-12" style="background:white;min-height: 500px;">
			...
			<div class="form-group">
				...
				<th scope="col" style="color:#000">Paid Leave</th>
				...
				<th scope="col" style="color:#000">Half Day</th>
...
$leave_result = $ci->Attendance_Model->get_current_day_leaves($emp['id']); 
//print_r($leave_result); ?>
	<?php		if(array_key_exists($emp['id'], $attendance)  && $attendance[$emp['id']] == "P") { ?>
			...
			<?php } ?>
				...
				<?php } else { ?>
				<?php if($leave_result['payment_type'] == 'Unpaid') { ?>
					<td><input type="radio" name="staff_<?php echo $emp['id'];?>" id="staff_id" value="A" checked
					...
					<?php } ?>
					<?php } ?>
					<?php if(array_key_exists($emp['id'], $attendance)  && $attendance[$emp['id']] == "PL") { ?>
				<td><input type="radio" name="staff_<?php echo $emp['id'];?>" id="staff_id" value="PL" checked onclick="makedefault_value1('<?php echo $emp['id'];?>','PL')"  /> </td>
				<?php } else { ?>
				<?php if($leave_result['payment_type'] == 'Paid') { ?>
					<td><input type="radio" name="staff_<?php echo $emp['id'];?>" id="staff_id" value="PL" checked onclick="makedefault_value('<?php echo $emp['id'];?>','PL')" /> </td>
					
					<?php } else { ?>
					<td><input type="radio" name="staff_<?php echo $emp['id'];?>" id="staff_id" value="PL" onclick="makedefault_value('<?php echo $emp['id'];?>','PL')" /> </td>
					<?php } ?>
					<?php } ?>
				...
				<td><input type="radio" name="staff_<?php echo $emp['id'];?>" id="staff_id" value="PH" checked  onclick="makedefault_value1('<?php echo $emp['id'];?>','PH')"/> </td>
					...
					<td><input type="radio" name="staff_<?php echo $emp['id'];?>" id="staff_id" value="PH" onclick="makedefault_value('<?php echo $emp['id'];?>','PH')"/> </td>
						...
						<?php if(array_key_exists($emp['id'], $attendance)  && $attendance[$emp['id']] == "HF") { ?>
				<td><input type="radio" name="staff_<?php echo $emp['id'];?>" id="staff_id" value="HF" checked  onclick="makedefault_value1('<?php echo $emp['id'];?>','HF')"/> </td>
					<?php } else { ?>
					<td><input type="radio" name="staff_<?php echo $emp['id'];?>" id="staff_id" value="HF" onclick="makedefault_value('<?php echo $emp['id'];?>','HF')"/> </td>
						<?php } ?>
