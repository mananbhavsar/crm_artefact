			...
			<div class="page-header row">
				...
				<div class="col-md-5 col-sm-5 col-xs-5">
					<small class="" style="position:relative;top:20px;right:20px;padding-right: 40px;text-align: left;float: right;">
						<strong><span class="text-uppercase"><?php echo lang('deposit') ?></span> <!--  Deposit Title in your language -->
					...
					<div class="list-group">
						<li class="list-group-item">
							...
							<span class="pull-right">
								<?php echo '' . amount_format($deposit[ 'sub_total' ], true). '' ?>
							</span>
						</li>
						<li class="list-group-item">
							<strong>
							...
							<span class="pull-right">
								<?php echo '' . amount_format($deposit[ 'total_tax' ], true). '' ?>
							</span>
						</li>
						<li class="list-group-item active">
							...
							<span class="pull-right">
								<?php echo '' . amount_format($deposit[ 'amount' ], true). ''; ?>
							</span>
						</li>
					</div>
				</div>
