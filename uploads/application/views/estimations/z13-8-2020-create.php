...
if($eachcustomer['company'] != '') { ?>
        ...
        <div layout-gt-xs="row">
          <div class="col-sm-6">
		  <div id="salesteam">
            <select  class="form-control selectpicker" required name="salesteam"  placeholder="Select Project Salesteam">
		 ...
		 <div  class="row centered-form " style="background:#fff;">
			   <div class=" col-xs-12 col-sm-8 col-md-12" id="example2" style="padding: 10px;" >
                      ...
                      <div class="col-sm-2 text-left"><b>Item Name</b>
                       ...
                       <div class="col-sm-3 text-left"><b>Item Description</b>
                      </div>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="row cloned-row" style="padding: 10px;" >
					  ...
					  <md-input-container class="md-block" style="margin-top: 5px !important;">
                       <textarea class="min_input_width" ng-model="<?php //print $eachItem['item_description'];?>" placeholder="<?php echo lang('description'); ?>" name="items[<?php print $i;?>][item_description][]"  id="item_description<?php print $i;?>"></textarea>
                        </md-input-container>
