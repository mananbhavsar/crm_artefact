          ...
          <button type="submit"  class="btn btn-sm btn-success">
		   ...
		   <md-menu md-position-mode="target-right target">
            ...
            <md-menu-content width="4">
                  ...
                  <md-button >
				    <a href="<?php print base_url()?>estimations/duplicate/<?php print $updateid;?>">
                    <div layout="row" flex>
                      <p flex > Duplicate</p>
...
if($client['clientname'] != '') { ?>
              <option value="<?php echo $client['client_id'];?>" <?php if($proposal['client_id']==$client['client_id']){print "selected='selected'";}?>>
...
if($contact['point_contact_name'] != '') { ?>
              <option value="<?php echo $contact['client_contact_id'];?>" <?php if($proposal['client_contact_id']==$contact['client_contact_id']){print "selected='selected'";}?>>
        ...
        <div layout-gt-xs="row">
          <div class="col-sm-6">
            <select id="salesteam" class="form-control" required name="salesteam"  placeholder="Select Project Salesteam">
              ...
              <option value="<?php print $eachSale['id']; ?>" <?php if($proposal['salesteam']==$eachSale['id']){print "selected='selected'";}?>>
