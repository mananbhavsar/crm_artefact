                ...
                <div class="panel panel-info">
                  <div class="panel-body">
                    ...
                    <div class="row cloned-row" style="padding: 10px;" >
                      ...
                      <div class="col-sm-4">
                        <input type="text" name="items[item_name][]"  id="item_name<?php print $i;?>" required="required" class="form-control"   />
                        <input type="hidden" value="0" id="nextcnt<?php print $i;?>">
                      </div>
                      <div class="col-sm-1">
                        <input type="text" name="items[qty][]" id="qty<?php print $i;?>" class="form-control" 	value="1"  onchange="main_item(this.value,<?php print $i;?>)">
                      </div>
                      <!--onchange="change_round_helper(0,0)" -->
                      <div class="col-sm-2">
                        <input type="text" name="items[unit_price][]" id="unit_price_<?php print $i;?>" class="form-control text-right" >
                      </div>
                      <div class="col-sm-1">
                        <input type="text" name="items[tax][]" id="tax_<?php print $i;?>" class="form-control" value="5">
                      </div>
                      <div class="col-sm-2">
                        <span id="tot<?php print $i;?>" class="form-control totalcostclass text-right">0
                        </span>
                        <input type="hidden" name="items[amount][]" id="amount_<?php print $i;?>" class="amt"/>
                      </div>
                      <div class="">
                    ...
                    <div style="border:1px solid #ddd;padding:10px;display:none" class="row " id="border_id_<?php print $i;?>_0">
                      <div class=" well clearfix sub-wrapper" >
                        <div id="wrapper_<?php print $i;?>_0">
                          <div data-count="<?php print $i;?>">
                            <div id="ac_id_<?php print $i;?>_0" style="display:none; margin-top:10px;" class="col-md-12"> 
