                    ...
                    <div class="row cloned-row" style="padding: 10px;" >
					 ...
					 <input type="hidden" value="<?php print $eachItem['item_description'];?>" id="itemdesc<?php print $i;?>">
                      ...
                      <div class="col-sm-1">
					   ...
					   <div class="col-sm-1">
                        <input type="text" name="items[<?php print $i;?>][item_discount][]" id="item_discount<?php print $i;?>" class="form-control" 	value="<?php print $eachItem['item_discount'];?>"  onchange="main_item_discount(this.value,<?php print $i;?>)" >
                      </div>
                      <div class="col-sm-1">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="row cloned-row" style="padding: 10px;" >
                      ...
                      <div class="col-sm-2">
                        ...
                        <input type="hidden" name="items[0][amount][]" id="amount_0" class="amt"/>
                      </div>
...
$('.sub_diff_new').each(function()
{
 ...
 $('#estimation_profit').html(formatNumber((sum).toFixed(2)));
    ...
    $('.itemdiscount').each(function() {
	  ...
	  if (!isNaN(total_discnt)){
		  $('#discount').attr('readonly', true);		  
		  
		  $('#discount').val(total_discnt);
	  }else{
