                            ...
                            <div id="ac_id_0_0" style="display:none; margin-top:10px;" class="col-md-12"> 
                              ...
                              <div style="width:30%;float:left;margin-right: 5px;">
                                <label class="control-label">Name
								 ...
								 <input type="text" class="form-control typeahead" data-provide="typeahead" data-hidden-field-id="name_id_0_0" name="supp[newsupplier][]" id="name_0_0" placeholder="Enter Material" autocomplete="off" >
