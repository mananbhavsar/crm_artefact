...
<div class="ciuis-body-content" >
  <div  class="main-content container-fluid col-xs-12 col-md-12 col-lg-9"> 
    <form  action="<?php echo base_url('estimations/update/'.$updateid.'') ?>" method="post" enctype="multipart/form-data">
...
if($client['clientname'] != '') { ?>
              <option value="<?php echo $client['client_id'];?>" <?php if($proposal['client_id']==$client['client_id']){print "seleced='selected'";}?>>
...
if($contact['point_contact_name'] != '') { ?>
        ...
        <input type="text" id="totalwgcount" name="totalwgcount" value="0">
        <div class="box-body">
	...
	foreach($estimation_main_items as $eachItem){
		$getsubitems=$this->Estimations_Model->get_estimation_main_sub_items($eachItem['main_item_id']);
		?>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="row cloned-row" style="padding: 10px;" >
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="text" value="0" id="nextcnt<?php print $i;?>">
                      </div>
                      <div class="col-sm-1">
                      ...
                      <div class="col-sm-2">
                        ...
                        <input type="text" name="items[amount][]" id="amount_<?php print $i;?>" class="amt" value="<?php print $eachItem['amount'];?>"/>
                      </div>
                      <div class="">
                          ...
                          <div data-count="<?php print $t;?>">
                            <div id="ac_id_<?php print $i;?>_<?php print $t;?>" style="display:block; margin-top:10px;" class="col-md-12"> 
							  ...
							  <?php }?>
                                ...
                                <input type="text" value="<?php print $i;?>" id="nextsubcnt_<?php print $i;?>_<?php print $t;?>">
                              </div>
        ...
        <input type="text" name="subitems[<?php print $i;?>][name][]" id="name_id_<?php print $i;?>_<?php print $t;?>" autocomplete="off" value="<?php if(is_numeric($getsubitems[$t]['name'])){print $getsubitems[$t]['material_id'];}else{print "-1";} ?>" class="allcategory"/>
                                <input type="text" id="matid_<?php print $i;?>_<?php print $t;?>" class="mid matidnew<?php print $i;?>" style="display:block;" value="<?php print $getsubitems[$t]['category'];?>">
							  ...
							  <?php if($t==0){?>
                                ...
                                <input type="text" id="exact_qnty_<?php print $i;?>_<?php print $t;?>" value="1"  >
                              </div>
							  <div style="width:10%;float:left;margin-right: 5px;">
							  <?php if($t==0){?>
							  ...
							  <?php if($t==0){?>
								...
								<input type="text" name="" id="margin_hidden_<?php print $i;?>_<?php print $t;?>" class="form-control margin_hidden_<?php print $i;?>_<?php print $t;?>" value="<?php print $getsubitems[$t]['margin']?>" />
                              </div>
							  ...
							  <?php if($t==0){?>
                                ...
                                <input type="text" name="subitems[<?php print $i;?>][selling_price][]" id="selling_price_<?php print $i;?>_<?php print $t;?>" class="sps_<?php print $i;?>" value="<?php print $getsubitems[$t]['selling_price']?>"/>
								 <input type="text" name="" id="final_sp_<?php print $i;?>_<?php print $t;?>" class="form-control final_sp_<?php print $i;?>_<?php print $t;?>" value="<?php if(is_numeric($getsubitems[$t]['name'])){print $getsubitems[$t]['last_selling_price'];} ?>"/>
                              </div>
                              <div style="width:7%;float:left;">
							  <?php if($t==0){?>
                                <label class="control-label">Action
							  </label><?php }?>
<div style="width:7%;float:left;"><a class="remove btn btn-danger" onclick="removediv(<?php print $i;?>,<?php print $t;?>);" id="rdiv<?php print $i;?><?php print $t;?>">-</a> </div>
                              </div>                          
                            </div>
                          </div>
						  <script>
                      ...
                      <div id="totals0" style="display:block" class="col-md-offset-1">
                        <div class="col-md-12" style="margin-bottom: 10px;">
                          ...
                          <input type="text" name="items[sub_tot_cost][]" id="sub_tot_cost<?php print $i;?>"  class="sub_cs" value="<?php print $eachItem['sub_tot_cost']?>"/>
                          <input type="text" name="items[sub_tot_cost_change][]" id="sub_tot_cost_change<?php print $i;?>"  class="sub_cs_change"/>
                          <input type="text" name="items[sub_tot_sp][]" id="sub_tot_sp<?php print $i;?>"class="sub_sp" value="<?php print $eachItem['sub_tot_sp']?>"/>
                        </div>
              ...
              <table class="table table-bordered col-md-6">
                <tr>
                  ...
                  <td>
                    ...
                    <input type="text" name="estimation_total_cost_amt" id="estimation_total_cost_amt" />
                  </td>
                </tr>
                <tr>
                  <th>Estimated Profit:
                  ...
                  <td>
                    ...
                    <input type="text" name="estimation_profit_amt" id="estimation_profit_amt" />
                  </td>
                </tr>
                </tr>
              </table>
            ...
            <table class="table table-bordered col-md-6">       
              <tr>
                ...
                <td>
                  ...
                  <input type="text" name="subtotal_amt" id="subtotal_amt" />
                </td>
              </tr>
              <tr>
                <th>Tax:
                ...
                <td>
                  ...
                  <input type="text" name="estimation_tax_amount" id="estimation_tax_amount" />
                </td>
              </tr>
              <tr>
                <th>Discount:
              ...
              <tr>
                ...
                <td>
                  ...
                  <input type="text" name="estimation_total_amt" id="estimation_total_amt" />
                </td>
              </tr>
              </tr>
            </table>
...
<div ><b>Total Cost:</b><span id="estimation_total_cost"></span><input type="text" name="estimation_total_cost_amt" id="estimation_total_cost_amt" /></div>
</div>
<div class="col-md-6" style="padding:10px;">
<div ><b>Sub Total:</b><span id="subtotal"></span><input type="text" name="subtotal_amt" id="subtotal_amt" /></div>
</div>
<div class="col-md-6" style="padding:10px;">
<div><b>Estimated Profit:</b><span id="estimation_profit"></span><input type="text" name="estimation_profit_amt" id="estimation_profit_amt" /></div>
</div>
<div class="col-md-6" style="padding:10px;">
...
<div class="col-md-6" style="padding:10px;">
<div ><b>Tax:</b><span id="estimation_tax"></span><input type="text" name="estimation_tax_amount" id="estimation_tax_amount" /></div>
</div>
<br></br>
<div class="col-md-6" style="padding:10px;">
<div ><b>Total Amount:</b><span id="estimation_total_amount"></span><input type="text" name="estimation_total_amt" id="estimation_total_amt" /></div>
</div>
-->
        </div>
