...
class Material_Model extends CI_Model {
	...
	function get_material_record($id){
	    	$this->db->select( '*,material_categories.mat_cat_name,material_unit_type.unit_name');
	...
	function get_vendor_material_records($id){
	    	$this->db->select( '*,vendors.company' );
	    	$this->db->join('vendors','vendors.id=vendor_materials.vendor_id','left');
		return $this->db->get_where( 'vendor_materials', array( 'material_id' => $id ) )->result_array();
...
function get_all_suppliers_material($id) {
	...
	function delete_vendor_material($material_id){
	   	return $this->db->delete('vendor_materials', array( 'material_id' => $material_id));
    ...
    function update_material($id, $params) {
		$response = $this->db->where('material_id', $id)->update('materials', $params);
	...
	function get_all_materials($type="") {
	...
	function add_material_vendor( $params ) {
		$this->db->insert( 'vendor_materials', $params );
		$staffmember = $this->db->insert_id();
