...
|
*/
if (!file_exists('application/config/system.config')) {
    ...
    $install_url .= 'install';
	include_once(APPPATH.'views/settings/notinstall.php');
    die();
}
...
|
*/
$config['encryption_key'] = 'cMUqKhsoZ3qV6y3kgARbJFdPqJvp7X2z';
