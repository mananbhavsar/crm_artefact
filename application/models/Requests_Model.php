...
class Requests_model extends CI_Model {
	...
	function get_all_mrequests($status) { 
		$this->db->select('*,CONCAT(projects.project_number,projects.name) as project_name,projects.name,material_req.id as mrid,staff.staffavatar,products.productname, material_req.status as status, material_req.created as created');
