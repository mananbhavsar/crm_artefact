...
<head>
	...
	<title>
		<?php echo lang('resetyourpassword')?>
	</title>
					...
					<md-card flex-xs flex-gt-xs="100" layout="column">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								echo form_open(site_url().'area/login/reset_password/'.$token, $fattr); ?>
								<div class="form-group">
									<input id="password" required="" type="password" placeholder="<?php echo lang('password')?>" name="password" autocomplete="off" class="form-control">
									<?php echo form_error('password') ?>
								</div>
								<div class="form-group">
									<input id="passconf" required="" type="password" placeholder="<?php echo lang('confirmpassword')?>" name="passconf" autocomplete="off" class="form-control">
