...
<div class="ciuis-body-content bg-white" ng-controller="Emails_Controller">
  <div class="main-content container-fluid col-xs-12 col-md-4 col-lg-4 bg-white">
    <div class="panel-heading" flex style="border-bottom: 1px solid gainsboro;"> <strong><?php echo lang('emails'); ?></strong> 
      <span class="panel-subtitle"><?php echo lang('email_activities'); ?> ({{emails.length}})</span> 
    </div>
    ...
    <div ng-show="!template.loadEmails" class="row" style="padding: 0px 20px 0px 20px;">
     <ul class="custom-ciuis-list-body" style="padding: 0px;" ng-cloak> 
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="col-md-3 pull-right timing" >
                    <span ng-bind="email.time | date:'dd, MMMM yyyy EEEE'"></span>
                  </div>
                </div>
              </div>
              <div class="row">
      ...
      <div class="pagination-div"  ng-hide="!emails.length" ng-cloak>
        <ul class="pagination">
      ...
      <md-content ng-show="!emails.length" class="md-padding bg-white no-item-data" ng-cloak><?php echo lang('noemails') ?></md-content>
    </div>
  </div>
  <div class="main-content container-fluid col-xs-12 col-md-8 col-lg-8 md-p-0 bg-white" style="border-left: 1px solid gainsboro;"> 
    ...
    <md-content>
      ...
      <md-tabs ng-show="!template.loader" md-dynamic-height md-border-bottom class="bg-white" ng-cloak>
        ...
        <md-tab label="<?php echo lang('proposals'); ?>">
          <md-content class="md-padding bg-white">
            <ul class="custom-ciuis-list-body" style="padding: 0px;"> 
              <li ng-repeat="template in templates | filter: { relation: 'proposal' || 'quote' }" class="milestone-todos-list ciuis-custom-list-item ciuis-special-list-item paginationclass" style="min-width: 100% !important;">
                <a href="<?php echo base_url('emails/template/')?>{{template.id}}">
                  <ul class="all-milestone-todos">
                    <li ng-show="template.status == '1'" class="milestone-todos-list-item col-md-12 done" style="color: unset;"> 
                      <span class="pull-left col-md-6">
        ...
        <md-tab label="<?php echo lang('depositstitle'); ?>" class="bg-white">
          <md-content class="md-padding bg-white">
            <ul class="custom-ciuis-list-body" style="padding: 0px;"> 
              <li ng-repeat="template in templates | filter: { relation: 'deposit' }  " class="milestone-todos-list ciuis-custom-list-item ciuis-special-list-item paginationclass" style="min-width: 100% !important;">
                <a href="<?php echo base_url('emails/template/')?>{{template.id}}">
                  <ul class="all-milestone-todos">
                    <li ng-show="template.status == '1'" class="milestone-todos-list-item col-md-12 done" style="color: unset;"> 
                      <span class="pull-left col-md-6">
        ...
        <md-tab label="<?php echo lang('quotes'); ?>">
          <md-content class="md-padding bg-white">
            <ul class="custom-ciuis-list-body" style="padding: 0px;"> 
              <li ng-repeat="template in templates | filter: { relation: 'quote' }  " class="milestone-todos-list ciuis-custom-list-item ciuis-special-list-item paginationclass" style="min-width: 100% !important;">
                <a href="<?php echo base_url('emails/template/')?>{{template.id}}">
                  <ul class="all-milestone-todos">
                    <li ng-show="template.status == '1'" class="milestone-todos-list-item col-md-12 done" style="color: unset;"> 
                      <span class="pull-left col-md-6">
        ...
        <md-tab label="<?php echo lang('purchases'); ?>" class="bg-white">
          <md-content class="md-padding bg-white">
            <ul class="custom-ciuis-list-body" style="padding: 0px;"> 
              <li ng-repeat="template in templates | filter: { relation: 'purchase' }  " class="milestone-todos-list ciuis-custom-list-item ciuis-special-list-item paginationclass" style="min-width: 100% !important;">
                <a href="<?php echo base_url('emails/template/')?>{{template.id}}">
                  <ul class="all-milestone-todos">
                    <li ng-show="template.status == '1'" class="milestone-todos-list-item col-md-12 done" style="color: unset;"> 
                      <span class="pull-left col-md-6">
    ...
    <md-dialog aria-label="Expense Detail">
      <md-toolbar class="toolbar-white">
        <div class="md-toolbar-tools">
          ...
          <span flex></span>
          <md-button ng-click="MoveToTrash(email.id)" class="md-icon-button" aria-label="Update">
