  ...
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
    <md-toolbar class="toolbar-white">
      <div class="md-toolbar-tools">
        ...
        <h5 style="margin-top:0px;" ng-bind="lead.lead_number"></h5>
        <strong style="margin-top:4%;margin-left:-8%" flex md-truncate ng-bind="lead.name"></strong>
        ...
        <?php if (check_privilege('leads', 'edit') || check_privilege('leads', 'delete')) { ?>  
          <md-menu md-position-mode="target-right target" ng-cloak>
            ...
            <md-menu-content width="4">
              ...
              <?php } if (check_privilege('leads', 'edit')) { ?> 
                <md-menu-item ng-show="lead.lost == '0'" class="lostBtn">
    ...
    <md-content ng-show="!leadsLoader" class="bg-white" ng-cloak>
      <md-tabs md-dynamic-height md-border-bottom>
          ...
          <div layout="row">
            <md-content class="bg-white" flex="50" style="border-right:1px solid #e0e0e0;">
              <md-list flex class="md-p-0 sm-p-0 lg-p-0">
                ...
                <md-list-item>
                  ...
                  <strong flex md-truncate><?php echo lang('created_date') ?></strong>
                  <p class="text-right" flex md-truncate ng-bind="lead.created"></p>
                </md-list-item>
                <md-divider></md-divider>
              </md-list>
            </md-content>
            <md-content class="bg-white" flex="50">
              <md-list flex class="md-p-0 sm-p-0 lg-p-0">
                ...
                <md-list-item>
                  <md-icon class="mdi mdi-local-phone"></md-icon>
                  <strong flex md-truncate><?php echo lang('Mobile') ?></strong>
                  <p class="text-right" flex md-truncate ng-bind="lead.mobile"></p>
                </md-list-item>
                <md-divider></md-divider>
                <md-list-item>
                ...
                <md-list-item>
                  <md-icon class="mdi mdi-book-image"></md-icon>
                  <strong flex md-truncate><?php echo lang('lastupdate') ?></strong>
                  <p class="text-right" flex md-truncate ng-bind="lead.dateassigned"></p>
                </md-list-item>
                <md-divider></md-divider>
              </md-list>
            </md-content>
        ...
        <md-tab label="<?php echo lang('activities') ?>">
  ...
  <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="Update" ng-cloak style="width: 450px;">
    <md-toolbar class="toolbar-white">
      <div class="md-toolbar-tools">
        ...
        <md-switch ng-model="lead.lead_status_id" aria-label="Active"><strong class="text-muted"><?php echo lang('active')?></strong></md-switch>
      </div>
    </md-toolbar>
    <md-content>
      <md-content layout-padding>
		...
		<md-input-container class="md-block">
          <label><?php echo lang('businesstype'); ?></label>
			<md-select placeholder="<?php echo lang('leads').' '.lang('group'); ?>" ng-model="lead.group_id" style="min-width: 200px;" required>
		...
		<!--<md-input-container class="md-block">
          <label><?php echo lang('companyemail'); ?></label>
          <input ng-model="lead.companyemail">
        </md-input-container>-->
        <br>
		<md-input-container class="md-block">
          <label><?php echo lang('Contact Person Mail Id'); ?></label>
          <input ng-model="lead.email" type="email"  minlength="10" maxlength="100" ng-pattern="/^.+@.+\..+$/">
        </md-input-container>
		<br>
		<md-input-container class="md-block">
        ...
        <md-input-container class="md-block">
          ...
          <md-select required placeholder="<?php echo lang('country'); ?>" ng-change="getStates(lead.country_id)" ng-model="lead.country_id" style="min-width: 200px;">
        ...
        <md-input-container class="md-block">
          ...
          <md-select placeholder="<?php echo lang('state'); ?>" ng-model="lead.state_id" name="state_id" style="min-width: 200px;">
        ...
        <md-input-container class="md-block pull-left">
          <md-checkbox ng-change="lead.type=false;ShowHideAssigned();lead.public=true;"  ng-model="lead.public"><?php echo lang('public') ?></md-checkbox>
        </md-input-container>
        <md-input-container class="md-block pull-left">
          <md-checkbox ng-change="lead.public=false;ShowHideAssigned();lead.type=true;"  ng-model="lead.type"><?php echo lang('individual') ?></md-checkbox>
        </md-input-container>
		<br/>		
  ...
  <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="ReminderForm" ng-cloak style="width: 450px;">
    ...
    <md-content layout-padding="">
      <md-content layout-padding>
        ...
        <md-input-container class="md-block">
          <label><?php echo lang('description') ?></label>
          <textarea name="description" ng-model="reminder_description" placeholder="<?php echo lang('typeSomething'); ?>" class="form-control note-description"></textarea>
        </md-input-container>
        <section layout="row" layout-sm="column" layout-wrap class="pull-right">
