    ...
    <md-content ng-show="!orderLoader" class="bg-white" ng-cloak>
      <md-table-container ng-show="orders.length > 0">
        <table md-table md-progress="promise">
          ...
          <tbody md-body>
            <tr class="select_row" md-row ng-repeat="order in orders | orderBy: order_list.order | filter: order_search | limitTo: order_list.limit : (order_list.page -1) * order_list.limit | filter: FilteredData" class="cursor">
