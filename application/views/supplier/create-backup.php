...
<div class="ciuis-body-content" ng-controller="Supplier_Controller">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4"><b>Company Full Name</b></label>
      <input type="email" class="form-control" id="inputEmail4" placeholder="Company Full Name">
    </div>
    <div class="form-group col-md-6">
  ...
  <div class="form-row">
   <div class="form-group col-md-4">
    <label for="inputAddress2">Contact Number Office</label>
    <input type="text" class="form-control" id="inputAddress2" placeholder="Contact Number Office">
  </div>
    <div class="form-group col-md-4">
