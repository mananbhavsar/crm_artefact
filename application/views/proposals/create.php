    ...
    <md-content ng-show="!proposalsLoader" class="bg-white" layout-padding ng-cloak>
      <div layout-gt-xs="row">
        ...
        <md-input-container ng-show="!proposal_type" class="md-block" flex-gt-xs>
          <md-select ng-model="customer" data-md-container-class="selectdemoSelectHeader">
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker md-min-date="created" name="opentill" ng-model="opentill" md-open-on-focus></md-datepicker>
        </md-input-container>
      </div>
      <div layout-gt-xs="row">
        <md-input-container class="md-block" flex-gt-xs>
