...
<div class="modal-body">
 <div ng-repeat="(prop, ignoredValue) in staff[0]" ng-init="filter[prop]={}" ng-if="prop != 'id' && prop != 'staffavatar'  && prop != 'name' && prop != 'expiry_date' && prop != 'created' && prop != 'remarks' && prop != 'documents' && prop != 'doc_count' && prop != 'company_name' && prop != 'category'&& prop != 'staffname' && prop != 'category'">
   ...
   <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="Create" ng-cloak style="width: 450px;">
       <form id="form1" method="post" id="myForm" action="<?php echo base_url('document/create');?>" enctype="multipart/form-data" onsubmit=" $('#loader-wrapper').show();">
...
<option value=""> Select..</option>
  ...
  <div class="form-group code">
    ...
    <input type="text" class="form-control" id="name" placeholder="Name or Number" name="name" value="" onchange="select_code(this.value)"  required>
  </div>
   <div class="form-group">
    <label for="">Expiry Date</label>
	<div class="input-group" >
	<input type="text" class="form-control" id="expiry_date"  name="expiry_date"  value="" placeholder="Expiry Date" required ><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
   </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Reminder Mail</label>
    <input type="text" class="form-control" id="reminder_mail" placeholder="Reminder Mail" name="reminder_mail" value="" required >
  </div>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="company_name" placeholder="Authorised Company Name" name="company_name" value="" required>
     
  </div>
 
  <div class="form-group">
    <label for="exampleInputPassword1">Contact Person</label>
    <input id="contact_person" type="text" class="form-control" name="contact_person" placeholder="Contact Person" required >
  
  </div>
 
  <div class="form-group">
    <label for="exampleInputPassword1">Contact Number</label>
    <input type="text" class="form-control" id="contact_number" placeholder="Contact Number" name="contact_number" value="" required>
  </div>
   <div class="form-group">
