...
<div class="modal-body">
 <div ng-repeat="(prop, ignoredValue) in staff[0]" ng-init="filter[prop]={}" ng-if="prop != 'id' && prop != 'name' && prop != 'expiry_date' && prop != 'created' && prop != 'remarks' && prop != 'documents' && prop != 'doc_count' && prop != 'company_name' && prop != 'category'">
   ...
   <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="Create" ng-cloak style="width: 450px;">
       <form id="form1" method="post" action="<?php echo base_url('document/create');?>">
