					...
					<div class="list-group">
						<li class="list-group-item">
							...
							<span class="pull-right">
								<?php echo '' . number_format( $purchase[ 'sub_total' ], 2, '.', ',' ) . ' ' . currency . '' ?>
							</span>
						</li>
						<li class="list-group-item">
							<strong>
							...
							<span class="pull-right">
								<?php echo '' . number_format( $purchase[ 'total_discount' ], 2, '.', ',' ) . ' ' . currency . '' ?>
							</span>
						</li>
						<li class="list-group-item">
							<strong>
							...
							<span class="pull-right">
								<?php echo '' . number_format( $purchase[ 'total_tax' ], 2, '.', ',' ) . ' ' . currency . '' ?>
							</span>
						</li>
						<li class="list-group-item active">
							...
							<span class="pull-right">
								<?php echo '' . number_format( $purchase[ 'total' ], 2, '.', ',' ) . ' ' . currency . ''; ?>
							</span>
						</li>
					</div>
				</div>
