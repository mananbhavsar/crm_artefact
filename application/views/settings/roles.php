		...
		<table md-table md-progress="promise">
			...
			<tbody md-body>
				<tr class="select_row" md-row ng-repeat="role in roles">
					...
					<td md-cell>
						<?php if (check_privilege('settings', 'edit')) { ?> 
							<span ng-click="get_role(role.role_id);getnameallselectedchilds();">
			...
			<tbody md-body>
				<tr ng-show="permission.key != 'quotes'" class="select_row" md-row ng-repeat-start='permission in all_permissions'>
				   <td md-cell class="width25">
						<md-checkbox ng-change="mainCheck(permission.id,permission.permission_check);" md-no-ink aria-label="view_own" ng-model="permission.permission_check" class="md-primary" id="permission.id"></md-checkbox>
						...
						<table md-table>
							<tbody md-body>
								...
								<tr class="select_row" md-row ng-repeat-start='chilItem in permission.child'>
									<td md-cell class="width25">
										<md-checkbox ng-change="mainSubCheck(chilItem.id,chilItem.permission_check)" md-no-ink aria-label="view_own" ng-model="chilItem.permission_check" class="md-primary"></md-checkbox>
		...
		<table md-table  md-progress="promise">
			...
			<tbody md-body>
				<tr class="select_row" md-row ng-repeat-start='permission in permissions'>
				   <td md-cell class="width25">
						<md-checkbox ng-change="mainCheckEdit(permission.id,permission.permission_check)" md-no-ink aria-label="view_own" ng-model="permission.permission_check" class="md-primary"></md-checkbox>
				        <button class="btn btn-primary btn-xs" ng-show="permission.viewChilds == 1" ng-click="viewChilds= !viewChilds">
						<!--<i class="fa fa-caret-down"></i>-->
						 <i class="fa fa-caret-down" ng-class="{'fa fa-caret-down': viewChilds != 1, 'fa fa-caret-up': viewChilds == 1}"></i>
						</button>
						<span ng-bind="permission.permission_key"></span>
						<span style="color:#0075bf !important" ng-show="all_child_selected_{{permission.id}}.length > 0"><strong>(<span ng-bind="all_child_selected_{{permission.id}}"></span>)</strong></span>
					</td>
					<td md-cell class="width15">
						<span ng-show="permission.viewChilds == 0">
					 ...
					 <td colspan='6' ng-class="viewChilds == 1? '' : 'hide'">
						<table md-table>
							<tbody md-body>
								...
								<tr class="select_row" md-row ng-repeat-start='chilItem in permission.child'>
									<td md-cell class="width25">
										<md-checkbox tri-state ng-change="mainSubEditCheck(chilItem.id,chilItem.permission_check)" md-no-ink aria-label="view_own" ng-model="chilItem.permission_check" class="md-primary" attr2="chilItem.parent"></md-checkbox>
										<button class="btn btn-primary btn-xs mrgn_lft30" ng-show="chilItem.viewChilds == 1" ng-click="viewSubChilds= !viewSubChilds">
										<i class="fa fa-caret-down" ng-class="{'fa fa-caret-down': viewSubChilds != 1, 'fa fa-caret-up': viewSubChilds == 1}"></i>
										</button>
										<span ng-class="{'mrgn_lft30': chilItem.viewChilds == 0 }">{{chilItem.permission_key}}</span>
									</td>
									<td md-cell class="width15">
										<span>
											<md-checkbox tri-state ng-show="chilItem.key != 'accounts' && chilItem.key != 'report' && chilItem.key != 'emails' && chilItem.key != 'settings' && role_type != 'other'" md-no-ink aria-label="view_own" ng-model="chilItem.permission_view_own" class="md-primary">
											</md-checkbox>
										</span>
									</td>
									<td md-cell class="width15">
										<span>  
											<md-checkbox tri-state md-no-ink aria-label="view_all" ng-model="chilItem.permission_view_all" class="md-primary">
											</md-checkbox>
										</span>
									</td>
									<td md-cell class="width15">
										<span>
											<md-checkbox tri-state ng-if="role_type == 'admin' || role_type == 'other'" ng-show="chilItem.key != 'report' && chilItem.key != 'emails' && role_type != 'other'" md-no-ink aria-label="create" ng-model="chilItem.permission_create" class="md-primary" ng-change="chilItem.permission_create?((!chilItem.permission_view_own && !chilItem.permission_view_all)? (chilItem.permission_view_own = true):''):''">
											</md-checkbox>
											<md-checkbox tri-state ng-if="role_type == 'staff'" ng-show="chilItem.key != 'report' && chilItem.key != 'emails' && role_type != 'other'" md-no-ink aria-label="create" ng-model="chilItem.permission_create" class="md-primary" ng-change="chilItem.permission_create?((!chilItem.permission_view_own && !chilItem.permission_view_all)? (chilItem.permission_view_own = true):''):''">
											</md-checkbox>
										</span>
									</td>
									<td md-cell class="width15">
										<span>
											<md-checkbox tri-state ng-if="role_type == 'admin' || role_type == 'other'" ng-show="chilItem.key != 'report' && role_type != 'other'" md-no-ink aria-label="edit" ng-model="chilItem.permission_edit" class="md-primary" ng-change="chilItem.permission_edit?((!chilItem.permission_view_own && !chilItem.permission_view_all)? (chilItem.permission_view_own = true):''):''">
											</md-checkbox>
											<md-checkbox tri-state ng-if="role_type == 'staff'" ng-show="chilItem.key != 'report' && role_type != 'other'" md-no-ink aria-label="edit" ng-model="chilItem.permission_edit" class="md-primary" ng-change="chilItem.permission_edit?((!chilItem.permission_view_own && !chilItem.permission_view_all)? (chilItem.permission_view_own = true):''):''">
											</md-checkbox>
										</span>
									</td>
									<td md-cell class="width15">
										<span>
											<md-checkbox tri-state ng-if="role_type == 'admin' || role_type == 'other'" ng-show="chilItem.key != 'report' && chilItem.key != 'emails' && role_type != 'other'" md-no-ink aria-label="delete" ng-model="chilItem.permission_delete" class="md-primary" ng-change="chilItem.permission_delete?((!chilItem.permission_view_own && !chilItem.permission_view_all)? (chilItem.permission_view_own = true):''):''">
											</md-checkbox>
											<md-checkbox tri-state ng-if="role_type == 'staff'" ng-show="chilItem.key != 'report' && chilItem.key != 'emails' && role_type != 'other'" md-no-ink aria-label="delete" ng-model="chilItem.permission_delete" class="md-primary" ng-change="chilItem.permission_delete?((!chilItem.permission_view_own && !chilItem.permission_view_all)? (chilItem.permission_view_own = true):''):''">
											</md-checkbox>
										</span>
									</td>
								</tr>
