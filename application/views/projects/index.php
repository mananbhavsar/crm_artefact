    ...
    <div class="projects-graph">
      <div class="col-md-12" style="padding: 0px;">
        <div class="panel-default">
          <div class="panel-heading panel-heading-divider xs-pb-15 text-bold" style="margin: 0px;"><?php echo lang('project').' '.lang('statuses'); ?>
    ...
    <md-content>
      <md-toolbar class="toolbar-white" style="background:#262626">
        <div class="md-toolbar-tools">
          ...
          <?php if (check_privilege('projects', 'create')) { ?> 
            <md-button aria-label="Add Status" class="md-icon-button" ng-click="NewStage()">
