					 ...
					 <input type="hidden" value="<?php print $eachItem['item_description'];?>" id="itemdesc<?php print $i;?>">
                      ...
                      <div class="col-sm-1">
					   ...
					   <div class="col-sm-1">
                        ...
                        $discntamt=($eachItem['sub_tot_sp']*$eachItem['item_discount'])/100;
                        
                        }else{$discntamt=0;}?>
                        <input type="text" name="discount_amt" value="<?php print $discntamt;?>" id="discount_amt<?php print $i;?>" class="itemdiscount1">
                      </div>
                      <div class="col-sm-1">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="row cloned-row" style="padding: 10px;" >
					  ...
					  <div class="col-sm-1">
                        ...
                        <input type="text" name="discount_amt" value="" id="discount_amt0" class="itemdiscount1">
                      </div>
                      <div class="col-sm-1">
