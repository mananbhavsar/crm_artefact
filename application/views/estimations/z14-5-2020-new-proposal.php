          ...
          <md-content class="md-padding bg-white">
            <div class="proposal">
              <main>
                  ...
                  <tbody>
					...
					<td  colspan="5" style="background: #fff;padding: 0px;">
                            ...
                            <div class="col-md-11 col-md-offset-1" style="border:1px solid #eee;    margin-bottom: 10px;    padding-bottom: 10px;"> 
							  ...
							  <div style="width:10%;float:left;margin-right: 5px;">
                                <br>
                                <?php echo $sub_items['unit_cost']; ?>
                              </div>
                              <div style="width:10%;float:left;margin-right: 5px;">
                               <br>
                                <?php echo $sub_items['total_cost']; ?>
                              </div>
                              <div style="width:8%;float:left;margin-right: 5px;">
                               <br>
                              <?php echo $sub_items['margin']; ?>
                              </div>
                              <div style="width:12%;float:left;margin-right: 5px;">
                               <br>
                                <?php echo $sub_items['selling_price']; ?>
                              </div>
				...
				<div class="col-md-9">
                    <div class="text-right text-uppercase text-muted"><?php echo 'Total Cost'?>:</div>
					</div>
					<div class="col-md-3 text-right">
					<?php echo $estimation_record['estimation_total_cost_amt'];?>
					</div>
					</div>
					<div class="col-md-12">
					<div class="col-md-9">
                    ...
                    <div class="text-right text-uppercase text-black"><?php echo 'Estimated Profit' ?>:</div></div></div><div class="col-md-3 text-right"><?php echo $estimation_record['estimation_profit_amt'];?></div></div>
                  </div>-->
                 </div> 
                <div class="col-md-12 md-pr-0" style="font-weight: 900; font-size: 16px; color: #c7c7c7;">
                  <div class="col-md-12">
				  <div class="col-md-10">
                    <div class="text-right text-uppercase text-muted"><?php echo lang('sub_total') ?>:</div></div><div class="col-md-2 text-right"><?php echo $estimation_record['subtotal_amt'];?></div></div>
					<div class="col-md-12">
				  <div class="col-md-10">
                    <div  class="text-right text-uppercase text-muted">
                    ...
                    <div class="text-right text-uppercase text-black">
					 <div class="col-md-10"><?php echo lang('grand_total') ?>:</div></div><div class="col-md-2 text-right"><?php echo $estimation_record['estimation_total_amt'];?></div></div>
                  </div>
                  <div class="col-md-2">
