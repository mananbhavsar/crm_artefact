...
if($eachcustomer['company'] != '') { ?>
        ...
        <div layout-gt-xs="row">
          <div class="col-sm-6">
		  <div id="salesteam">
            <select  class="form-control selectpicker"  name="salesteam"  placeholder="Select Project Salesteam">
                ...
                <div class="panel panel-info">
                  <div class="panel-body">
                    ...
                    <div class="row cloned-row" style="padding: 10px;" >
                      ...
                      <div class="col-sm-2">
                        <input type="text" name="items[item_name][]"  id="item_name0" required="required" class="form-control" placeholder="Item Name"  />
                        <input type="hidden" value="0" id="nextcnt0">
                      </div>
                       <div class="col-sm-2">
                             <md-input-container class="md-block" style="margin-top: 5px !important;">
                       <textarea class="min_input_width" ng-model="item.description" placeholder="<?php echo lang('description'); ?>" name="items[item_description][]"  id="item_description0"></textarea>
                        </md-input-container>
                        
                      </div>
                      <div class="col-sm-1">
                        <input type="text" name="items[qty][]" id="qty0" class="form-control" 	value="1"  onchange="main_item(this.value,0)" placeholder="quantity">
                      </div>
                      <!--onchange="change_round_helper(0,0)" -->
                      <div class="col-sm-1">
                        <input type="text" name="items[unit_price][]" id="unit_price_0" class="form-control text-right" placeholder="Unit Price" >
                      </div>
					  <div class="col-sm-1">
                        <input type="text" name="items[item_discount][]" id="item_discount0" class="form-control text-right itemdiscount" placeholder="Discount" onchange="main_item_discount(this.value,0)">
                      </div>
                      <div class="col-sm-1">
...
//alert(sum);
 $('#estimation_profit').html(formatNumber(sum.toFixed(2)));	
  ...
  function main_item_discount(val,workgroup_count){
	  ...
	  var distotal=totalamt*(val/100);
	  var discnttotal=totalamt - distotal;
