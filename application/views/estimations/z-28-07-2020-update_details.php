...
<script>
  $(document).ready(function(){
	...
	function checkapproval(){
		$('.approvalModel').css('display','none');
		var estimationTotal = typeof $("#estimation_total_amt") == 'undefined' ? 0 : $("#estimation_total_amt").val();
		var maxvalue = $("#max_val").val();
		$('#estimatestatus').attr('disabled','disabled');
		if(parseInt(maxvalue) >= parseInt(estimationTotal)){
			$('.approvalModel').css('display','block');
			$('#estimatestatus').removeAttr('disabled');
		}
	}
...
<span id="dtotal<?php print $i;?>" class="sub_diff"><?php print $profit;?>
                              </span>
            ...
            <table class="table table-bordered col-md-6">       
              ...
              <tr>
                ...
                <td>
				  ...
				  <input type="hidden" name="max_val" id="max_val" value="<?php echo $maxvalue;?>"/>
                </td>
              </tr>
              </tr>
            </table>
