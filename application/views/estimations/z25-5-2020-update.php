...
if($contact['point_contact_name'] != '') { ?>
	...
	foreach($estimation_main_items as $eachItem){
                          ...
                          <div data-count="<?php print $t;?>">
                            <div id="ac_id_<?php print $i;?>_<?php print $t;?>" style="display:block; margin-top:10px;" class="col-md-12"> 
							  ...
							  <?php }?>
                                ...
                                <input type="hidden" value="1" id="nextsubcnt_<?php print $i;?>_<?php print $t;?>">
                              </div>
        ...
        <input type="hidden" name="subitems[<?php print $i;?>][name][]" id="name_id_<?php print $i;?>_<?php print $t;?>" autocomplete="off" value="<?php if(is_numeric($getsubitems[$t]['name'])){print $getsubitems[$t]['material_id'];}else{print "-1";} ?>" class="allcategory"/>
