			 ...
			 <div id="details" class="clearfix">
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tbody>
					...
					<td colspan="5" style="background: #fff;padding: 0px;">
					 ...
					 <div class="col-md-8">
					<b>Total Item Cost:</b><?php print $main_items['sub_tot_cost'];?></div> <div class="col-md-3">
					<b>Total Selling Price:</b><?php print $main_items['sub_tot_sp'];?></div>
					</div>
					</td>
				...
				<div class="col-md-12 md-pr-0" style="font-weight: 900; font-size: 16px; color: #c7c7c7;">
				  ...
				  <div class="col-md-10">
                    ...
                    <div  class="text-right text-uppercase text-muted">
                      <?php echo $estimation_record['estimation_tax_amount']; ?></div>
					  </div>
					  </div>
					  <div class="col-md-12">
