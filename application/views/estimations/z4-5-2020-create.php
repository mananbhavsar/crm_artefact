          ...
          <div class="input_fields_container_part">
            <div  class="row centered-form " style="background:#fff;">
			   <div class=" col-xs-12 col-sm-8 col-md-12" id="example2" style="padding: 10px;" >
                      ...
                      <div class="col-sm-4 text-center">Item Name
                      </div>
                      <div class="col-sm-1">Qty
                      </div>
                      <div class="col-sm-2">Unit Price
                      </div>
                      <div class="col-sm-1">Tax % 
                      </div>
                            ...
                            <div id="ac_id_0_0" style="display:none; margin-top:10px;" class="col-md-11 col-md-offset-1" > 
                              ...
                              <div class="col-sm-2">
                                <label class="control-label">Name
								 ...
								 <input type="text" class="form-control typeahead" data-provide="typeahead" data-hidden-field-id="name_id_0_0" name="supp[newsupplier][]" id="name_0_0" placeholder="Enter Material" autocomplete="off" required>
...
-->
      ...
      <div class="col-md-12">
        <div class="form-group ">
          ...
          <textarea type="text" class="form-control" id="special_notes" placeholder="" name="special_notes" rows="5" cols="30">
          </textarea>
        </div>
        <div class="form-group ">
          <md-toolbar class="toolbar-white _md _md-toolbar-transitions">
...
<div class="main-content container-fluid col-xs-12 col-md-12 col-lg-3 md-pl-0">
  ...
  <md-content class="bg-white _md">
   ...
   <md-toolbar class="toolbar-white _md _md-toolbar-transitions">
    <div class="md-toolbar-tools"> 
      <h2 class="md-pl-10 md-truncate flex" flex="" md-truncate="">Categories Estimations
      </h2>
    </div>
  </md-toolbar>
  <md-content class="bg-white _md">
...
<script type="text/javascript">
        ...
        $('.allcategory').each(function() {
          ...
          if(selectedid!=''){
            ...
            if(status=='Exist'){
              mid=$(this).attr('id');
              var midsp=mid.split('_');
              $('#margin_'+midsp[1]+'_'+midsp[2]+'').val(str);
              var unitcost=$('#unit_cost_'+midsp[1]+'_'+midsp[2]+'').val();
              select_subcost(unitcost,midsp[1],midsp[2])
            }
          }
  ...
  function select_workgroup(num){
    ...
    $('.input_fields_container_part').append("<div id='workgroup_id"+val+"' class='row centered-form' style='background:#fff;'><div class='col-xs-12 col-sm-8 col-md-12 '><div class='panel panel-info'><div class='panel-body'><div class='row cloned-row' style='padding: 10px;'><div class='col-sm-1'><b><input type='checkbox' style='padding-right:10px;' id='check_price_"+val+"' onclick='change_margin_value("+val+")' class='checkall'> "+k+"</b></div><div class='col-sm-4'><input type='text' name='items[item_name][]' id='item_name"+val+"' class='form-control' /><input type='hidden' value='0' id='nextcnt"+val+"'></div><div class='col-sm-1'><input type='text' name='items[qty][]' id='qty"+val+"' class='form-control' value='1' onchange='main_item(this.value,"+val+")'></div><div class='col-sm-2'><input type='text' name='items[unit_price][]' id='unit_price_"+val+"' class='form-control  text-right' ></div><div class='col-sm-1'><input type='text' name='items[tax][]' id='tax_"+val+"' class='form-control' value='5'></div><div class='col-sm-2'><span id='tot"+val+"' class='form-control totalcostclass text-right'>0</span><input type='hidden' name='items[amount][]' id='amount_"+val+"' class='amt'/></div><div class=''> <button class='btn btn-success removeclass' type='button' onclick='select_activity("+val+",0);' style='float: left;margin-right:1px;'><i class='glyphicon glyphicon-circle-arrow-down'></i></button> <button class='btn btn-success' type='button' onclick='remove_activity("+val+",0);'><i class='glyphicon glyphicon-trash'></i></button></div></div><div style='border: 1px solid rgb(221, 221, 221); padding: 10px;display:none;' class='row ' id='border_id_"+val+"_0'><div class=' well clearfix sub-wrapper'><div id='wrapper_"+val+"_0'><div data-count='0'><div id='ac_id_"+val+"_0' style='display:none;' class='d col-md-11 col-md-offset-1' style='margin-top: 10px;'><div class='' ><div class='col-sm-1'><b>1</b></div><div class='col-sm-1 pd0'><label class='control-label'>Sku</label><input type='text' name='subitems["+val+"][sku][]' id='sku_"+val+"_0'  class='form-control '/><input type='hidden'  id='nextsubcnt_"+val+"_0'  class='form-control' value='0'/></div><div class='col-sm-2'><label class='control-label'>Name</label><input type='text' id='matid_"+val+"_0' class='mid matidnew"+val+"' style='display:none;'><input type='text' class='form-control typeahead' data-provide='typeahead' data-hidden-field-id='name_id_"+val+"_0' name='supp[newsupplier][]' id='name_"+val+"_0' placeholder='Enter Material' autocomplete='off' required><input type='hidden' name='subitems["+val+"][name][]' id='name_id_"+val+"_0' autocomplete='off' value='' class='allcategory'/></div><div class='col-sm-1 pdleft0'><label class='control-label'>Qty</label><input type='text' name='subitems["+val+"][qty][]' id='quantity_"+val+"_0' class='form-control' value='1' onchange='save("+val+",0);'/><input type='hidden' id='exact_qnty_"+val+"_0' value=''></div><div class='col-sm-1' style='padding:0px;'><label class='control-label'>Unit Cost</label><input type='text' name='subitems["+val+"][unit_cost][]' id='unit_cost_"+val+"_0' class='form-control text-right' onchange='select_subcost(this.value,"+val+",0)'/></div><div class='col-sm-2'><label class='control-label'>Total Cost</label><input type='text' name='subitems["+val+"][total_cost][]' id='total_cost_"+val+"_0' class='text-right form-control tc_"+val+"' readonly /></div><div class='col-sm-1' style='padding:0px;'><label class='control-label'>Margin % </label><input type='text' name='subitems["+val+"][margin][]' id='margin_"+val+"_0' class='form-control selling_price_"+val+"_0' onchange='change_margin(this.value,"+val+",0)'/><input type='hidden' name='' id='margin_hidden_"+val+"_0' class='form-control margin_hidden_"+val+"_0'></div><div class='col-sm-2'><label class='control-label'>Selling Price</label><br><span id='sp_"+val+"_0' class='form-control text-right'>0</span><input type='hidden' name='subitems["+val+"][selling_price][]' id='selling_price_"+val+"_0' class='sps_"+val+"' /></div></div></div></div></div><button id='add' onclick='save("+val+",0)' class='btn btn-success btn-lg' style='float:right;margin-right:10px;' type='button'> save</button></div><div id='totals"+val+"' style='display:none' class='col-md-offset-1'><div class='col-md-12' style='margin-bottom: 10px;'><div class='text-danger'><div class='col-md-7 p-1 text-right '><b>Item Cost:</b></div><div class='col-md-2 p-1'><span id='sub_total_cost"+val+"' >0.00</span></div><div class='col-md-2 p-1'>Item Selling Price: <span id='sub_total_sp"+val+"' >0.00</span></div><input type='hidden' name='items[sub_tot_cost][]' id='sub_tot_cost"+val+"' class='sub_cs'/><input type='hidden' name='items[sub_tot_cost_change][]' id='sub_tot_cost_change"+val+"' class='sub_cs_change'/><input type='hidden' name='items[sub_tot_sp][]' id='sub_tot_sp"+val+"' class='sub_sp' /></div></div><div class='col-md-6'></div><div class='col-md-3 row'><div class='col-sm-4'><b>Round Helper:</b></div><div class='col-sm-5'><input type='text' name='items[round_helper][]' id='round_helper"+val+"' class='form-control' size='4' onchange='select_round(this.value,"+val+")' value='0'></div></div><div class='col-md-2' style='display:none;'><b>Total:</b><span id='ototal"+val+"'></span><br>Difference: <span id='dtotal"+val+"' class='sub_diff'></span></div></div></div><hr/></div></div></div>");
 ...
 var seen='';
  ...
  function add_activity(value,workgroup_count,activity_count){
    ...
    $.ajax({
      ...
      success:function(response) {
        ...
        if(strlen==0){
          $("#destination").append('<div class="errorDiv col-md-12" id="removediv'+response.mat_cat_id+'"><md-list-item ng-repeat="department in departments" role="listitem" class="_md-button-wrap ng-scope _md md-clickable" tabindex="-1" style=""><div class="md-button md-no-style">   <div class="md-list-item-inner"> <span class="errorDivstr" style="display:none;">'+response.mat_cat_id+'</span>  <div class="col-md-9" ><strong>'+response.mat_cat_name+'</strong></div><div class="col-md-3"> <input type="text" class="form-control"  value=""  data-id='+response.mat_cat_id+'></div><md-divider></md-divider>   </div><div class="md-secondary-container"></div></div></md-list-item></div>');
		  
		   $("#destination1").append('<div class="errorDiv1 col-md-12 row" id="removediv1'+response.mat_cat_id+'"><md-list-item ng-repeat="department in departments" role="listitem" class="_md-button-wrap ng-scope _md md-clickable" tabindex="-1" style=""><div class="md-button md-no-style" style="padding: 0px !important;">   <div class="md-list-item-inner"> <span class="errorDivstr1" style="display:none;">'+response.mat_cat_id+'</span>  <div class="col-md-4"><strong>'+response.mat_cat_name+'</strong></div> <div class="col-md-4"><input type="text" class="form-control totalcost'+response.mat_cat_id+'"  value=""  data-id='+response.mat_cat_id+' ></div><div class="col-md-4"><input type="text" class="form-control sellingprice'+response.mat_cat_id+'" data-id='+response.mat_cat_id+'></div><md-divider></md-divider>   </div><div class="md-secondary-container"></div></div></md-list-item></div>');
        }
        else{
          var yourArray = [];
          $('.errorDivstr').each(function() {
          ...
          if(status=='Not exist'){
            $("#destination").append('<div class="errorDiv col-md-12" id="removediv'+response.mat_cat_id+'"><md-list-item ng-repeat="department in departments" role="listitem" class="_md-button-wrap ng-scope _md md-clickable" tabindex="-1" style=""><div class="md-button md-no-style">   <div class="md-list-item-inner"> <span class="errorDivstr" style="display:none;">'+response.mat_cat_id+'</span>  <div class="col-md-9" ><strong>'+response.mat_cat_name+'</strong></div><div class="col-md-3"> <input type="text" class="form-control"  value=""  data-id='+response.mat_cat_id+' ></div><md-divider></md-divider>   </div><div class="md-secondary-container"></div></div></md-list-item></div>');
			 ...
			 $("#destination1").append('<div class="errorDiv1 col-md-12 row" id="removediv1'+response.mat_cat_id+'"><md-list-item ng-repeat="department in departments" role="listitem" class="_md-button-wrap ng-scope _md md-clickable" tabindex="-1" style=""><div class="md-button md-no-style" style="padding: 0px !important;">   <div class="md-list-item-inner"> <span class="errorDivstr1" style="display:none;">'+response.mat_cat_id+'</span>  <div class="col-md-4"><strong>'+response.mat_cat_name+'</strong></div> <div class="col-md-4"><input type="text" class="form-control totalcost'+response.mat_cat_id+'"  value=""  data-id=totalcost'+response.mat_cat_id+' ></div><div class="col-md-4"><input type="text" class="form-control sellingprice'+response.mat_cat_id+'" data-id=sellingprice'+response.mat_cat_id+'></div><md-divider></md-divider>   </div><div class="md-secondary-container"></div></div></md-list-item></div>');
          }
        }
		...
		$('#name_'+workgroup_count+'_'+activity_count).val(response.itemname);
          ...
          if(status=='Exist'){
			...
			var sprice=$('#selling_price_'+totida[1]+'_'+totida[2]+'').val();
			 var value1 = parseFloat(sprice);
			  ...
			  $('.sellingprice'+catid+'').val(sellingprice);
		 $('.totalcost'+catid+'').val(tcost);
  ...
  function addMore(workgroup_count,activity_count){
    ...
    var act_count = $('#wrapper_'+workgroup_count+'_'+activity_count+' > div:last').data('count')+1 || 0;
    var j = act_count+1;
    $('#wrapper_'+workgroup_count+'_'+activity_count+'').append("<div data-count='"+act_count+"'><div id='ac_id_"+workgroup_count+"_"+act_count+"' class='d col-md-11 col-md-offset-1' style='margin-top: 10px;' ><div class='' ><div class='col-sm-1 ' >"+j+"</div><div class='col-sm-1 pd0' ><input type='text' name='subitems["+workgroup_count+"][sku][]' id='sku_"+workgroup_count+"_"+act_count+"'  class='form-control pd0 '/><input type='hidden' id='nextsubcnt_"+workgroup_count+"_"+act_count+"'  class='form-control  ' value='0'/></div><div class='col-sm-2'><input type='text' id='matid_"+workgroup_count+"_"+act_count+"' class='mid  matidnew"+workgroup_count+"' style='display:none;'><input type='text' class='form-control typeahead' data-provide='typeahead' data-hidden-field-id='name_id_"+workgroup_count+"_"+act_count+"' name='supp[newsupplier][]' id='name_"+workgroup_count+"_"+act_count+"' placeholder='Enter Material' autocomplete='off' required><input type='hidden' name='subitems["+workgroup_count+"][name][]' id='name_id_"+workgroup_count+"_"+act_count+"' autocomplete='off' value='' class='allcategory'/></div><div class='col-sm-1 pdleft0'><input type='text' name='subitems["+workgroup_count+"][qty][]' id='quantity_"+workgroup_count+"_"+act_count+"' class='form-control' value='1' onchange='save("+workgroup_count+",0);'/><input type='hidden' id='exact_qnty_"+workgroup_count+"_"+act_count+"' value=''></div><div class='col-sm-1' style='padding:0px;'><input type='text' name='subitems["+workgroup_count+"][unit_cost][]' id='unit_cost_"+workgroup_count+"_"+act_count+"' class='form-control text-right' onchange='select_subcost(this.value,"+workgroup_count+","+act_count+")'/></div><div class='col-sm-2'><input type='text' name='subitems["+workgroup_count+"][total_cost][]' id='total_cost_"+workgroup_count+"_"+act_count+"' class='text-right form-control tc_"+workgroup_count+"' readonly /></div><div class='col-sm-1' style='padding:0px;'><input type='text' name='subitems["+workgroup_count+"][margin][]' id='margin_"+workgroup_count+"_"+act_count+"' class='form-control selling_price_"+workgroup_count+"_"+act_count+"' onchange='change_margin(this.value,"+workgroup_count+","+act_count+");'/><input type='hidden' name='' id='margin_hidden_"+workgroup_count+"_"+act_count+"' class='form-control margin_hidden_0_0' /></div><div class='col-sm-2'><span id='sp_"+workgroup_count+"_"+act_count+"' class='form-control text-right'>0</span><input type='hidden' name='subitems["+workgroup_count+"][selling_price][]' id='selling_price_"+workgroup_count+"_"+act_count+"' class='sps_"+workgroup_count+"' /></div><div class='col-sm-1'><a  class='remove btn btn-danger' onclick='removediv("+workgroup_count+","+act_count+");'>-</a> </div></div></div>");
