...
<?php
	...
	<?php 
		  ...
		  <select onchange="showdateselection(this.value)" name="priority" id="priority" class="text-uppercase selectpicker" data-width="100%">
			...
			<option value="2" <?php if(isset($task) && $task['priority']==2){print "selected='selected'";}?>>High</option>
			<option value="3" <?php if(isset($task) && $task['priority']==3){print "selected='selected'";}?>>Medium</option>
