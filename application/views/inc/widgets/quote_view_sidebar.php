    ...
    <div class="panel-default panel-table borderten lead-manager-head" style="overflow: scroll;">
      <div class="panel-heading">
        <div id="details" class="clearfix" style="font-size: 12px;">
          <div id="proposal">
            <h1><?php echo get_number('proposals',$proposals['id'],'proposal','proposal') ?></h1>
            <div class="date"><?php echo lang('dateofissuance')?>:<?php switch($settings['dateformat']){case 'yy.mm.dd': echo _rdate($proposals['date']);break;case 'dd.mm.yy': echo _udate($proposals['date']); break;case 'yy-mm-dd': echo _mdate($proposals['date']); break;case 'dd-mm-yy': echo _cdate($proposals['date']); break;case 'yy/mm/dd': echo _zdate($proposals['date']); break;case 'dd/mm/yy': echo _kdate($proposals['date']); break;}?></div>
        ...
        <div class="btn-group col-md-12 md-pr-0 md-pl-0 md-pb-10">
          ...
          <a target="_blank" href="<?php echo base_url('share/pdf_proposal/'.$proposals['token'].''); ?>" class="btn btn-default btn-big col-md-4"><i class="icon ion-document"></i> <?php echo lang('pdf')?> </a></div>
        ...
        <?php }?>
        <div style="<?php if($proposals['comment']!=1){echo 'display:none;';}?>"> <?php echo form_open_multipart('area/quotes/customercomment',array("class"=>"")); ?>
