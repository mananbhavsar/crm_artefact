...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('assets/css/ciuis.css') ?>">
	<style>
		.amex {
...
<body>
	...
	<div id="authorize_gateway">
		<div class="container">
			<div id="Checkout" class="inline">
				<h1>Pay Invoice</h1>
				<div class="card-row"> <span class="visa"></span> <span class="mastercard"></span> <span class="amex"></span> <span class="discover"></span> </div>
				<form method="post" action="<?php echo base_url('gateway/pushPayment');?>">
					<input type="hidden" class="form-control" id="fname" name="fname" placeholder="Enter First Name" value="<?php if($customer['type']===1){echo $customer['namesurname'];} else echo $invoice['company']; ?>">
					<input type="hidden" class="form-control" id="lname" name="lname" placeholder="Enter Last Name" value="">
					<input type="hidden" class="form-control" id="inv_id" name="inv_id" value="<?php echo $invoice['id'] ?>">
					<input type="hidden" class="form-control" id="address" name="address" placeholder="Enter Address" value="<?php echo $customer['address'] ?>">
					<input type="hidden" class="form-control" id="city" name="city" placeholder="Enter City" value="<?php echo $customer['city'] ?>">
					<input type="hidden" class="form-control" id="state" name="state" placeholder="Enter State" value="<?php echo $customer['state'] ?>">
					<input type="hidden" class="form-control" id="country" name="country" placeholder="Enter Country" value="<?php echo $customer['country'] ?>">
					<input type="hidden" class="form-control" id="phone" name="phone" placeholder="Enter Phone" value="<?php echo $customer['phone'] ?>">
					<input type="hidden" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="Enter email" value="<?php echo $customer['email'] ?>">
					<input type="hidden" class="form-control" id="camount" name="camount" placeholder="Enter Amount" value="<?php echo $invoice['total']?>">
					<div class="form-group">
						<label for="PaymentAmount">Payment amount</label>
						<div class="amount-placeholder"> <span>$</span>
							<span>
					...
					<div class="form-group">
						...
						<input id="cdesc" name="cdesc" class="form-control" type="text" maxlength="500" value="<?php if($customer['type']===1){echo $customer['namesurname'];} else echo $invoice['company']; ?> <?php echo sprintf( lang( 'paymentfor' ), get_number('invoices',$invoice['id'],'invoice','inv') )?>">
						</input>
					</div>
					<div class="form-group">
						<label for="CreditCardNumber">Card number</label>
						<input id="cnumber" name="cnumber" class="null card-image form-control" type="text">
						</input>
					</div>
					<div class="expiry-date-group form-group">
						<label for="cexpdate">Expiry date</label>
						<input id="cexpdate" name="cexpdate" class="form-control" type="text" placeholder="MM / YY" maxlength="7">
						</input>
					</div>
					<div class="security-code-group form-group">
						...
						<div class="input-container">
							...
							<i id="cvc" class="fa fa-question-circle"></i> </div>
					...
					<div class="zip-code-group form-group">
						...
						<div class="input-container">
							<input id="zip" name="zip" class="form-control" type="text" maxlength="10" value="<?php echo $customer['zipcode'] ?>">
							</input>
							<a tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-placement="left" data-content="Enter the ZIP/Postal code for your credit card billing address."><i class="fa fa-question-circle"></i></a> </div>
					</div>
					<button id="PayButton" class="btn btn-block btn-success submit-button" type="submit"> <span class="submit-button-lock"></span> <span class="align-middle">Pay $<?php echo $invoice['total']?></span> </button>
				</form>
			</div>
		</div>
	</div>
