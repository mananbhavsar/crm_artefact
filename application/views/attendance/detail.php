  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-3">
	 ...
	 <div class="form-group col-md-2">
      ...
      <input type="file" class="form-control" name="passport_doc[]" multiple id="passport_doc">
    </div>
    <div class="form-group col-md-2">
 ...
 <div class="form-row">
    ...
    <div class="form-group col-md-3">
	 ...
	 <div class="form-group col-md-2">
      ...
      <input type="file" class="form-control"  name="emirates_doc[]" multiple id="emirates_doc">
    </div>
   ...
   <div class="form-row">
    ...
    <div class="form-group col-md-3">
	 ...
	 <div class="form-group col-md-2">
      ...
      <input type="file" class="form-control" name="labour_doc[]" multiple id="labour_doc">
    </div>
    ...
    <div class="form-group col-md-3">
	 ...
	 <div class="form-group col-md-2">
      ...
      <input type="file" class="form-control" name="atm_doc[]" multiple id="atm_doc">
    </div>
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" name="others" id="inputZip" value="<?php  echo @$documents->others ;?>">
    </div>
    <div class="form-group col-md-3">
        <label for="inputState">Expiry Date</label>
			<div class="input-group date">
        <input type="text" name="other_expiry_date" class="form-control newdatepicker" id="other_expiry_date" value="<?php  echo @$documents->other_expiry_date ;?>"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
        </div>
      
    </div>
	  <div class="form-group col-md-2">
      <label for="inputZip">Remind Me</label>
      <input type="text" class="form-control" name="others_remind" id="inputZip" placeholder="Remind Me" value="<?php  echo @$documents->others_remind ;?>">
    </div>
	 <div class="form-group col-md-2">
      <label for="inputCity">Upload Docs</label>
      <input type="hidden" name="old_others_data" value="<?php echo @$documents->others_doc ;?>">
      <input type="file" class="form-control" name="others_doc[]" multiple id="others_doc">
    </div>
