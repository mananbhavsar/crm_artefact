function Otherrequests_Controller($scope, $http, $mdSidenav, $mdDialog, $filter, $q) {
	"use strict";
	...
	$http.get(BASE_URL + 'otherrequests/get_requests').then(function (Projects) {
...
function Otherrequest_Controller($scope, $http, $mdSidenav, $q, $timeout, $mdDialog, $filter, $sce, fileUpload) {
	"use strict";
...
CiuisCRM.controller('Otherrequests_Controller', Otherrequests_Controller);
CiuisCRM.controller('Otherrequest_Controller', Otherrequest_Controller);
